...
import { getDashboardCounts, getOrderStatusCounts, getRecentOrdersData } from '../models/dashboardModel';

const getDashboardMetrics = async (req: Request, res: Response): Promise<void> => {  
  try {
...
const getOrderStatusSummary = async (req: Request, res: Response): Promise<void> => {
  try {
